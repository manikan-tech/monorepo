  ...
  return (
    <div className="flex flex-col flex-1">
      <nav className="flex-1 mt-6 px-4 space-y-2">
        <Link
          href="/dashboard"
          className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-colors duration-200 ${pathname === "/dashboard"
        ...
        {isActivated && (
          <>
            ...
            <Link
              ...
              className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-colors duration-200 ${pathname.startsWith("/dashboard/orders")
                  ? "bg-forest-800 text-white shadow-soft"
                  : "text-forest-50 hover:bg-forest-800 hover:text-white"
                }`}
            >
            ...
            <Link
              ...
              className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-colors duration-200 ${pathname.startsWith("/dashboard/analytics")
                  ? "bg-forest-800 text-white shadow-soft"
                  : "text-forest-50 hover:bg-forest-800 hover:text-white"
                }`}
            >
        ...
        <Link
          ...
          className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-colors duration-200 ${pathname.startsWith("/dashboard/services")
              ? "bg-forest-800 text-white shadow-soft"
              : "text-forest-50 hover:bg-forest-800 hover:text-white"
            }`}
        >
