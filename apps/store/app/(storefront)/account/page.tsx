      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-8">
          ...
          <div className="bg-white rounded-3xl p-8 border border-forest-900/5 shadow-soft">
            ...
            <div className="space-y-4 pt-6 border-t border-forest-900/5">
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium text-forest-900/60">
                  Phone
                </span>
          ...
          <div className="bg-white rounded-3xl p-6 border border-forest-900/5 shadow-soft">
            <h3 className="font-display font-medium text-forest-950 mb-4">
              Settings
            </h3>
            <div className="flex flex-col gap-2">
              <Link
                href="/account/addresses"
                className="flex items-center justify-between px-4 py-3 rounded-xl hover:bg-forest-50 text-forest-800 text-sm font-medium transition-colors"
              >
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-3xl p-8 border border-forest-900/5 shadow-soft h-full">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-display font-semibold text-forest-950">
                Recent Orders
              </h2>
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <div className="w-16 h-16 bg-forest-50 rounded-full flex items-center justify-center text-forest-900/30 mb-4">
                  <svg
                    ...
                    strokeWidth="1.5"
                  >
                    <path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 1 4 0M9 5h6m-3 7h3m-3 4h3M9 12h.01M9 16h.01" />
                  </svg>
                </div>
                <h3 className="font-display text-xl font-medium text-forest-950">
                  No orders yet
                </h3>
                <p className="text-forest-700/70 text-sm mt-1 mb-6">
                  You haven't placed any orders.
                </p>
                <Link
                  href="/store"
                  className="bg-forest-900 text-white rounded-xl px-6 py-2.5 font-medium hover:bg-forest-800 transition-colors"
                >
                  Start Shopping
                </Link>
              </div>
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <span
                          className={`text-xs font-semibold px-3 py-1.5 rounded-full border ${STATUS_COLORS[order.status] ?? "bg-gray-50 text-gray-600 border-gray-200"}`}
                        >
                          {order.status}
                        </span>
                        {order.paymentStatus === "REFUNDED" && (
                          <span className="text-xs font-semibold px-3 py-1.5 rounded-full border bg-violet-50 text-violet-700 border-violet-200">
                            Refunded
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      {order.items.slice(0, 3).map((item: any) => (
                        <div
                          key={item.id}
                          className="text-sm text-forest-900 bg-forest-50 rounded-lg px-3 py-1.5 flex items-center gap-2"
                        >
                          <img
                      ...
                      {order.items.length > 3 && (
                        <span className="text-sm text-forest-700/50">
                    ...
                    <div className="flex items-center justify-between mt-5 pt-5 border-t border-forest-900/5">
                      ...
                      <span className="text-sm font-medium text-gold-600 group-hover:underline">
                        Order Details →
                      </span>
                    </div>
                  </Link>
