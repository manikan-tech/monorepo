...
export default function OrdersPage() {
  ...
  return (
    <div className="max-w-[900px] mx-auto px-6 py-12 md:py-20 w-full">
      <h1 className="font-display text-4xl font-semibold text-forest-950 mb-10 animate-fade-in-up">
        My Orders
      </h1>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center gap-4 py-20 text-center animate-fade-in-up">
          ...
          <Link
            href="/store"
            className="mt-2 bg-forest-900 text-white rounded-xl px-8 py-3 font-medium hover:bg-forest-800 transition-colors"
          >
            Start Shopping
          </Link>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-3 flex-wrap">
                {order.items.slice(0, 3).map((item) => (
                  <div
                    key={item.id}
                    className="text-sm text-forest-900 bg-forest-50 rounded-lg px-3 py-1.5"
                  >
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t border-forest-900/5">
                <span className="text-xl font-semibold text-forest-950">
