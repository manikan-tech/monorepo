        ...
        <div className="max-w-[1200px] mx-auto px-6 w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <FeatureCard
              ...
              description="LangGraph agent reasons over your size charts and the shopper's body measurements to recommend the right size with a natural language explanation."
              icon={
            ...
            <FeatureCard
              ...
              description="Shoppers upload a photo and see themselves wearing the actual garment fabric, color, print and all before they buy."
              icon={
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
            ...
            <FeatureCard
              ...
              description="Track widget usage, recommendation accuracy stats, and catalog performance from a dedicated analytics dashboard."
              icon={
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
            ...
            <FeatureCard
              ...
              description="Upload your product CSV once. We parse, validate, and index your size charts automatically. Update anytime from the dashboard."
              icon={
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
